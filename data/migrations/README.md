...
- `004_create_relationships_table.sql` - Cria tabela Relationships para relacionamentos descobertos entre fontes (RF03.2)
...
psql -h localhost -U delfos -d delfos_metadata -f data/migrations/004_create_relationships_table.sql
```
...
docker exec -i delfos-postgres psql -U delfos -d delfos_metadata < data/migrations/004_create_relationships_table.sql
```
...
5. **Relationships** - Relacionamentos descobertos entre tabelas de fontes distintas (RF03.2)
